# Urban Fantasy Romance V3 - Input Files
...
```
Run step 1 for urban-fantasy-romance-v3
```

Or run the entire workflow at once:

```
Run the entire workflow for urban-fantasy-romance-v3
```
...
All outputs will be saved to `projects/urban-fantasy-romance-v3/outputs/`
