# Urban Fantasy Romance V1 - Input Files
...
```
Run step 1 for urban-fantasy-romance-v1
```

Or run the entire workflow at once:

```
Run the entire workflow for urban-fantasy-romance-v1
```
...
All outputs will be saved to `projects/urban-fantasy-romance-v1/outputs/`
