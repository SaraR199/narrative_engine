# Task: Extract High-Level Dramatic Spine

You are analyzing three foundational documents to identify the **dramatic spine** of this story—the invisible force lines that create and move tension throughout the narrative.

## What is a Dramatic Spine?

The dramatic spine is NOT a plot outline. It's the underlying tension architecture that tells you:
- What forces are pulling on the characters
- How emotional pressure builds and releases
- What energy the story radiates
- Where the story is emotionally traveling from/to

Think of it as the story's "tone thermostat" and "tension blueprint."
...
- **Lush** - Rich sensory detail, immersive atmosphere, slow beauty
- **Sharp** - Cutting dialogue, precision, intellectual clarity
- **Bantery** - Witty, playful, verbal sparring, charm
- **Eerie** - Unsettling, creeping dread, uncanny
- **Comedic** - Humor-first, absurdity, lightness
- **Melancholic** - Wistful, bittersweet, reflective sadness
- **Visceral** - Physical, immediate, raw sensation
- **Propulsive** - Fast, relentless momentum, page-turner energy
- **Lyrical** - Poetic, musical language, elevated prose
- **Intimate** - Close, quiet, introspective, emotional microscope
- **Other** - Define it specifically

**Output for Dominant Energy:**
- Name the energy
- Describe how it should FEEL to read this book
- Give 2-3 concrete examples of how this energy shows up (in prose style, pacing, scene texture, etc.)

### 4. Emotional Progression (5-Step Arc)

Map the emotional journey of the book in 5 distinct stages. This is NOT plot—it's the emotional FEELING the reader experiences as they move through the story.

Use this format:

**A → B → C → D → E**

Each step should be a 1-2 word emotional state or energy, followed by a brief description.

Example format:
- **A (Opening):** Curiosity tinged with unease — Reader is drawn in but senses something is off
- **B (Early story):** Growing dread — Discomfort intensifies, questions multiply
- **C (Midpoint shift):** Revelation shock — A truth explodes, everything recontextualizes
- **D (Deepening):** Grief and understanding — Pain of the truth settles in, meaning emerges
- **E (Resolution):** Bittersweet acceptance — Peace with complexity, no easy answers

**Your Output:**
Create the 5-step emotional progression for THIS story based on the concepts provided.
...
## Dominant Energy
[Name]: [Description of the book's ambient feel]
...
- **A (Opening):** [Emotional state] — [Brief description]
- **B (Early story):** [Emotional state] — [Brief description]
...
Analyze the three concept documents and extract the dramatic spine.
